...
def userWriter(file:str,modeAppend:str,atribute1:str,typeOperation:str,atribute2:str):
    with open({file}, {modeAppend}, newline="") as f:
        writer = csv.writer(f)
        writer.writerow([{atribute1}, {typeOperation}, {atribute2}])
        
def userWriter(file:str,modeWriter:str,atribute1:str,atribute2:str,atribute3:str):
